...
class R3BAsyKrabReader : public R3BReader {
 ...
 private:
  ...
  int mynev;
  int xring[triggerbox_number_of_boards][triggerbox_number_of_FPGA_per_board]
           [num_channels];
  int xringch[triggerbox_number_of_boards][triggerbox_number_of_FPGA_per_board]
             [num_channels];
  float xringang[triggerbox_number_of_boards]
                [triggerbox_number_of_FPGA_per_board][num_channels];

  int xtboxring[triggerbox_number_of_boards *
                triggerbox_number_of_FPGA_per_board * num_channels];
  int xtboxch[triggerbox_number_of_boards *
              triggerbox_number_of_FPGA_per_board * num_channels];
  int xtbox[triggerbox_number_of_boards * triggerbox_number_of_FPGA_per_board *
            num_channels];
  int xtboxringch[triggerbox_number_of_boards *
                  triggerbox_number_of_FPGA_per_board * num_channels];
  float xtboxang[triggerbox_number_of_boards *
                 triggerbox_number_of_FPGA_per_board * num_channels];
  int xtboxboard[triggerbox_number_of_boards *
                 triggerbox_number_of_FPGA_per_board * num_channels];
  int xtboxinp[triggerbox_number_of_boards *
               triggerbox_number_of_FPGA_per_board * num_channels];
  int xtboxfpga[triggerbox_number_of_boards *
                triggerbox_number_of_FPGA_per_board * num_channels];
  int xtboxfpgach[triggerbox_number_of_boards *
                  triggerbox_number_of_FPGA_per_board * num_channels];
  int xtboxcrock[triggerbox_number_of_boards *
                 triggerbox_number_of_FPGA_per_board * num_channels];
  int xtboxcrockch[triggerbox_number_of_boards *
                   triggerbox_number_of_FPGA_per_board * num_channels];
