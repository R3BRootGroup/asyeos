...
class AsyChimeraReader : public R3BReader {
 public:
  // Standard constructor
  AsyChimeraReader(EXT_STR_h101_ASYCHIMERA_onion*, size_t);

  // Destructor
  virtual ~AsyChimeraReader();
 ...
 private:
  ...
  EXT_STR_h101_ASYCHIMERA_onion* fData;
  // Data offset
  size_t fOffset;
 ...
 public:
  ClassDefOverride(AsyChimeraReader, 0);
};
