...
#define EXT_STR_h101_ASYKRAB_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                            \
    ...
    {                                                                                                                  \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               "KRAB_SAMP_ACCEPT",                                                                     \
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(ok, si, offset, struct_t, printerr, KRAB_I, UINT32, "KRAB_I", 33, 0 /*flags*/);         \
        EXT_STR_ITEM_INFO2_ZZP(ok, si, offset, struct_t, printerr, KRAB_Iv, UINT32, "KRAB_Iv", "KRAB_I", 0 /*flags*/); \
        EXT_STR_ITEM_INFO2_LIM(ok, si, offset, struct_t, printerr, KRAB_DATA, UINT32, "KRAB_DATA", 33, 0 /*flags*/);   \
