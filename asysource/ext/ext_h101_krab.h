...
#define EXT_STR_h101_ASYKRAB_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ...
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     TIMESTAMP_KRAB_WR_T1,            UINT32,\
                    "TIMESTAMP_KRAB_WR_T1",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     TIMESTAMP_KRAB_WR_T2,            UINT32,\
                    "TIMESTAMP_KRAB_WR_T2",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     TIMESTAMP_KRAB_WR_T3,            UINT32,\
                    "TIMESTAMP_KRAB_WR_T3",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     TIMESTAMP_KRAB_WR_T4,            UINT32,\
                    "TIMESTAMP_KRAB_WR_T4",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     KRAB_I,                          UINT32,\
                    "KRAB_I",32,0/*flags*/); \
