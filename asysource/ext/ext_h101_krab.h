...
typedef struct EXT_STR_h101_ASYKRAB_t
{
    ...
    uint32_t KRAB_I /* [0,34] */;
    uint32_t KRAB_Iv[34 EXT_STRUCT_CTRL(KRAB_I)] /* [-1,-1] */;
    uint32_t KRAB_DATA /* [0,34] */;
    uint32_t KRAB_DATAv[34 EXT_STRUCT_CTRL(KRAB_DATA)] /* [-1,-1] */;
...
typedef struct EXT_STR_h101_ASYKRAB_onion_t
{
    ...
    uint32_t KRAB_I;
    uint32_t KRAB_Iv[34 /* KRAB_I */];
    uint32_t KRAB_DATA;
    uint32_t KRAB_DATAv[34 /* KRAB_DATA */];
...
#define EXT_STR_h101_ASYKRAB_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                            \
    ...
    {                                                                                                                  \
        ...
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, KRAB_SAMP_TBOX, UINT32, "KRAB_SAMP_TBOX", 512, 0 /*flags*/);           \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, KRAB_SAMP_TRIGONE, UINT32, "KRAB_SAMP_TRIGONE", 512, 0 /*flags*/);     \
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               si,                                                                                     \
                               offset,                                                                                 \
                               struct_t,                                                                               \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, KRAB_SAMP_TRIGTWO, UINT32, "KRAB_SAMP_TRIGTWO", 512, 0 /*flags*/);     \
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               si,                                                                                     \
                               offset,                                                                                 \
                               struct_t,                                                                               \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(                                                                                        \
            ok, si, offset, struct_t, printerr, KRAB_SAMP_ACCEPT, UINT32, "KRAB_SAMP_ACCEPT", 512, 0 /*flags*/);       \
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               si,                                                                                     \
                               offset,                                                                                 \
                               struct_t,                                                                               \
        ...
        EXT_STR_ITEM_INFO2_ZZP(ok,                                                                                     \
                               ...
                               "KRAB_SAMP_ACCEPT",                                                                     \
                               0 /*flags*/);                                                                           \
        EXT_STR_ITEM_INFO2_LIM(ok, si, offset, struct_t, printerr, KRAB_I, UINT32, "KRAB_I", 34, 0 /*flags*/);         \
        EXT_STR_ITEM_INFO2_ZZP(ok, si, offset, struct_t, printerr, KRAB_Iv, UINT32, "KRAB_Iv", "KRAB_I", 0 /*flags*/); \
        EXT_STR_ITEM_INFO2_LIM(ok, si, offset, struct_t, printerr, KRAB_DATA, UINT32, "KRAB_DATA", 34, 0 /*flags*/);   \
