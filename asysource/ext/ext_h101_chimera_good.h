...
#define EXT_STR_h101_ASYCHIMERA_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ...
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     S2FRONTDE,                       UINT32,\
                    "S2FRONTDE",32,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     S2FRONTDEI,                      UINT32,\
                    "S2FRONTDEI",                      "S2FRONTDE",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     S2FRONTDEv,                      UINT32,\
                    "S2FRONTDEv",                      "S2FRONTDE",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     S2BACKDE,                        UINT32,\
                    "S2BACKDE",32,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     S2BACKDEI,                       UINT32,\
                    "S2BACKDEI",                       "S2BACKDE",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     S2BACKDEv,                       UINT32,\
                    "S2BACKDEv",                       "S2BACKDE",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     S2FRONTTOF,                      UINT32,\
                    "S2FRONTTOF",32,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     S2FRONTTOFI,                     UINT32,\
                    "S2FRONTTOFI",                     "S2FRONTTOF",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     S2FRONTTOFv,                     UINT32,\
                    "S2FRONTTOFv",                     "S2FRONTTOF",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     S2BACKTOF,                       UINT32,\
                    "S2BACKTOF",32,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     S2BACKTOFI,                      UINT32,\
                    "S2BACKTOFI",                      "S2BACKTOF",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     S2BACKTOFv,                      UINT32,\
                    "S2BACKTOFv",                      "S2BACKTOF",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     PATTERNCHI,                      UINT32,\
                    "PATTERNCHI",32,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     PATTERNCHII,                     UINT32,\
                    "PATTERNCHII",                     "PATTERNCHI",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     PATTERNCHIv,                     UINT32,\
                    "PATTERNCHIv",                     "PATTERNCHI",0/*flags*/); \
  \
} while (0);
