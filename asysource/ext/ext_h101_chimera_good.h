...
#define EXT_STR_h101_ASYCHIMERA_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                         \
    ...
    {                                                                                                                  \
        ok = 1;                                                                                                        \
        /* INFO */                                                                                                     \
        EXT_STR_ITEM_INFO2(ok, si, offset, struct_t, printerr, TSTAMPLO, UINT32, "TSTAMPLO", 0 /*flags*/);             \
        EXT_STR_ITEM_INFO2(ok, si, offset, struct_t, printerr, TSTAMPHI, UINT32, "TSTAMPHI", 0 /*flags*/);             \
        EXT_STR_ITEM_INFO2(ok, si, offset, struct_t, printerr, TSTAMPSRCID, UINT32, "TSTAMPSRCID", 0 /*flags*/);       \
        EXT_STR_ITEM_INFO2(ok, si, offset, struct_t, printerr, MERGE_STATUS, UINT32, "MERGE_STATUS", 0 /*flags*/);     \
        EXT_STR_ITEM_INFO2(ok, si, offset, struct_t, printerr, MERGE_IDMASK, UINT32, "MERGE_IDMASK", 0 /*flags*/);     \
        /* RAW */                                                                                                      \
