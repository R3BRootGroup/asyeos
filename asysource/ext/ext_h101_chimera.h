...
#define EXT_STR_h101_ASYCHIMERA_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ...
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     CHIM_FAST,                       UINT32,\
                    "CHIM_FAST",399,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_FASTI,                      UINT32,\
                    "CHIM_FASTI",                      "CHIM_FAST",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_FASTv,                      UINT32,\
                    "CHIM_FASTv",                      "CHIM_FAST",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     CHIM_RG_FAST,                    UINT32,\
                    "CHIM_RG_FAST",399,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_RG_FASTI,                   UINT32,\
                    "CHIM_RG_FASTI",                   "CHIM_RG_FAST",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_RG_FASTv,                   UINT32,\
                    "CHIM_RG_FASTv",                   "CHIM_RG_FAST",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     CHIM_RG_SLOW,                    UINT32,\
                    "CHIM_RG_SLOW",399,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_RG_SLOWI,                   UINT32,\
                    "CHIM_RG_SLOWI",                   "CHIM_RG_SLOW",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_RG_SLOWv,                   UINT32,\
                    "CHIM_RG_SLOWv",                   "CHIM_RG_SLOW",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     CHIM_RG_SIL,                     UINT32,\
                    "CHIM_RG_SIL",376,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_RG_SILI,                    UINT32,\
                    "CHIM_RG_SILI",                    "CHIM_RG_SIL",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_RG_SILv,                    UINT32,\
                    "CHIM_RG_SILv",                    "CHIM_RG_SIL",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     CHIM_SLOW,                       UINT32,\
                    "CHIM_SLOW",399,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_SLOWI,                      UINT32,\
                    "CHIM_SLOWI",                      "CHIM_SLOW",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_SLOWv,                      UINT32,\
                    "CHIM_SLOWv",                      "CHIM_SLOW",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     CHIM_TIME,                       UINT32,\
                    "CHIM_TIME",399,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_TIMEI,                      UINT32,\
                    "CHIM_TIMEI",                      "CHIM_TIME",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_TIMEv,                      UINT32,\
                    "CHIM_TIMEv",                      "CHIM_TIME",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     CHIM_SIL,                        UINT32,\
                    "CHIM_SIL",376,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_SILI,                       UINT32,\
                    "CHIM_SILI",                       "CHIM_SIL",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_SILv,                       UINT32,\
                    "CHIM_SILv",                       "CHIM_SIL",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     CHIM_TOFSIL,                     UINT32,\
                    "CHIM_TOFSIL",376,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_TOFSILI,                    UINT32,\
                    "CHIM_TOFSILI",                    "CHIM_TOFSIL",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     CHIM_TOFSILv,                    UINT32,\
                    "CHIM_TOFSILv",                    "CHIM_TOFSIL",0/*flags*/); \
  \
} while (0);
