...
void R3BAsyChimeraContFact::setAllContainers()
{
    ...
    FairContainer* p1 = new FairContainer("ChimeraCalPar", "Chimera Cal Parameters", "ChimeraCalParContext");
    p1->addContext("ChimeraCalParContext");
    containers->Add(p1);

    FairContainer* p2 = new FairContainer("ChimeraHitPar", "Chimera Hit Parameters", "ChimeraHitParContext");
    p2->addContext("ChimeraHitParContext");
    containers->Add(p2);

    FairContainer* p3 = new FairContainer("ChimeraGeoPar", "Chimera geometry parameters", "GeometryParameterContext");
...
FairParSet* R3BAsyChimeraContFact::createContainer(FairContainer* c)
{
    ...
    {
        p = new R3BAsyChimeraCalPar(c->getConcatName().Data(), c->GetTitle(), c->getContext());
    }

    if (strcmp(name, "ChimeraHitPar") == 0)
    {
        p = new R3BAsyChimeraHitPar(c->getConcatName().Data(), c->GetTitle(), c->getContext());
    }
