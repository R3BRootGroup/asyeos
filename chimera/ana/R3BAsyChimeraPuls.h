...
#ifndef R3BASYCHIMERAPULS_H
#define R3BASYCHIMERAPULS_H
 ...
 */
class R3BAsyChimeraPuls : public FairTask
{
  public:
    /**
     * Default constructor.
     ...
     */
    R3BAsyChimeraPuls(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BAsyChimeraPuls();
