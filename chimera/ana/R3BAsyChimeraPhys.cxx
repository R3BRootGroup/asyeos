...
InitStatus R3BAsyChimeraPhys::Init()
{
    ...
    c_RP2->Divide(2, 2);
    c_RP2->cd(1);
    h2_RP_CHI_KRAB->Draw("ZCol");
    c_RP2->cd(2);
    h1_dRP_CHI_KRAB->Draw();
    h1_dRP_CHI_KRAB->SetMinimum(0);
    ...
    c_b->Divide(2, 2);
    c_b->cd(1);
    h2_mulCHI_mulKRAB->Draw("ZCol");
    hp_mulCHI_mulKRAB->Draw("same");
    c_b->cd(2);
    h2_ZBound_mulKRAB->Draw("Zcol");
    hp_ZBound_mulKRAB->Draw("same");
    c_b->cd(3);
    h2_Zrat_mulKRAB->Draw("Zcol");
    hp_Zrat_mulKRAB->Draw("same");
    c_b->cd(4);
    h2_Erat_mulKRAB->Draw("Zcol");
    hp_Erat_mulKRAB->Draw("same");
    ...
    c_b2->Divide(2, 2);
    c_b2->cd(2);
    h2_ZBound_mulCHI->Draw("Zcol");
    hp_ZBound_mulCHI->Draw("same");
    c_b2->cd(3);
    h2_Zrat_mulCHI->Draw("Zcol");
    hp_Zrat_mulCHI->Draw("same");
    c_b2->cd(4);
    h2_Erat_mulCHI->Draw("Zcol");
    hp_Erat_mulCHI->Draw("same");
    ...
    c_b2->cd(1);
    h2_ZBound_Zrat->Draw("Zcol");
    hp_ZBound_Zrat->Draw("same");
    ...
    cc4_bis->Divide(1, 3);
    cc4_bis->cd(1);
    h1_yield_Z1_bis->Draw();
    cc4_bis->cd(2);
    h1_yield_Z2_bis->Draw();
    cc4_bis->cd(3);
    h1_yield_Z3_bis->Draw();

    cc5_bis = new TCanvas("cc5_bis", "cc5_bis", 1000, 1000);
    cc5_bis->Divide(1, 3);
    cc5_bis->cd(1);
    h1_yield_Z4_bis->Draw();
    cc5_bis->cd(2);
    h1_yield_Z5_bis->Draw();
...
void R3BAsyChimeraPhys::Reset_Histo() { LOG(info) << "R3BAsyChimeraPhys::Reset_Histo"; }
    ...
    if (trig == 1 && tpat & 2)
    {
        ...
        if (fChimeraIdData && fChimeraIdData->GetEntriesFast())
        {
            ...
            for (Int_t ihit = 0; ihit < nHits; ihit++)
            {
                ...
                if (NumTel == 93 && (this_energy == 280 || this_energy == 400 || this_energy == 600))
                    continue; // bad 400, 280
                if (NumTel == 108 && (this_energy == 280 || this_energy == 400 || this_energy == 600))
                    continue; // bad 400, 280
                if (NumTel == 129 && (this_energy == 280 || this_energy == 400 || this_energy == 600))
                    continue; // bad 400, 280
                if (NumTel == 185 && (this_energy == 280 || this_energy == 400 || this_energy == 600))
                    continue; // bad 400, 280
                if (NumTel == 213 && (this_energy == 400))
                    continue; // bad 400
                if (NumTel == 267 && (this_energy == 280 || this_energy == 400 || this_energy == 600))
                    continue; // bad 400, 280
                if (NumTel == 332 && (this_energy == 280 || this_energy == 400))
                    continue; // bad 400, 280
                if (NumTel == 366 && (this_energy == 600))
                    continue; // bad 600
                if (NumTel == 380 && (this_energy == 280 || this_energy == 400 || this_energy == 600))
                    continue; // bad 400, 280
                if (NumTel == 383 && (this_energy == 280 || this_energy == 400 || this_energy == 600))
                    continue; // bad 400, 280
                if (NumTel == 391 && (this_energy == 280 || this_energy == 400 || this_energy == 600))
                    continue; // bad 400, 280

                if (NumTel == 125 && (this_energy == 280 || this_energy == 400))
                    continue; // brutto 400
                if (NumTel == 198 && (this_energy == 280))
                    continue; // brutto 280
                if (NumTel == 150 && (this_energy == 280))
                    continue; // brutto 280

                // to flatten
                if (NumTel == 80 && (this_energy == 280 || this_energy == 400 || this_energy == 600))
                    continue; // 400, 280
                if (NumTel == 112 && (this_energy == 280 || this_energy == 400))
                    continue; // 400, 280
                if (NumTel == 144 && (this_energy == 400))
                    continue; // 400
                if (NumTel == 184 && (this_energy == 280))
                    continue; // 280
                ...
                if (Icod >= 0 && Icod <= 5 && EsuA > 15 && EsuA < EAMax && Z >= 1 && Z <= 5)
                {
                    ...
                    if (Z >= 2)
                        ZBound = ZBound + Z;
                    if (Z == 1)
                        h1_yield_Z1->Fill(NumTel);
                    if (Z == 2)
                        h1_yield_Z2->Fill(NumTel);
                    if (Z == 3)
                        h1_yield_Z3->Fill(NumTel);
                    if (Z == 4)
                        h1_yield_Z4->Fill(NumTel);
                    if (Z == 5)
                        h1_yield_Z5->Fill(NumTel);
                    ...
                    if (NumTel >= 80 && NumTel <= 399)
                    {
                        ...
                        {
                            if (Z == 1)
                                h1_yield_Z1_bis->Fill(NumTel);
                            if (Z == 2)
                                h1_yield_Z2_bis->Fill(NumTel);
                            if (Z == 3)
                                h1_yield_Z3_bis->Fill(NumTel);
                            if (Z == 4)
                                h1_yield_Z4_bis->Fill(NumTel);
                            if (Z == 5)
                                h1_yield_Z5_bis->Fill(NumTel);

                            //		       std:: cout << "R3BAsyChimPhys:: mult_RP = " << mult_RP << std::endl;
                            qqx[mult_RP] = qx;
                            qqy[mult_RP] = qy;

                            if (NumTel >= 80 && NumTel <= 111)
                                h1_ntel_R3I->Fill(NumTel, gammabt * A);
                            if (NumTel >= 112 && NumTel <= 143)
                                h1_ntel_R3E->Fill(NumTel, gammabt * A);
                            if (NumTel >= 144 && NumTel <= 183)
                                h1_ntel_R4I->Fill(NumTel, gammabt * A);
                            if (NumTel >= 184 && NumTel <= 223)
                                h1_ntel_R4E->Fill(NumTel, gammabt * A);
                            if (NumTel >= 224 && NumTel <= 263)
                                h1_ntel_R5I->Fill(NumTel, gammabt * A);
                            if (NumTel >= 264 && NumTel <= 303)
                                h1_ntel_R5E->Fill(NumTel, gammabt * A);
                            if (NumTel >= 304 && NumTel <= 351)
                                h1_ntel_R6I->Fill(NumTel, gammabt * A);
                            if (NumTel >= 352 && NumTel <= 399)
                                h1_ntel_R6E->Fill(NumTel, gammabt * A);
                        }
        ...
        { // 29 run 108
            if (RP_KRAB > -181 && RP_CHI > -181)
            {
                ...
                if (dRP_CHI_KRAB < -180)
                    dRP_CHI_KRAB = -360 - dRP_CHI_KRAB;
                if (dRP_CHI_KRAB > 180)
                    dRP_CHI_KRAB = 360 - dRP_CHI_KRAB;
                if (dRP_CHI_KRAB < 0)
                    dRP_CHI_KRAB = -dRP_CHI_KRAB;
            ...
            if (dRP_CHI_KRAB > 120)
            {
                for (int j = 0; j < mult_RP; j++)
                {
                    ...
                    float rrr2 = rr2->Rndm();
                    if (mult_RPa >= mult_RP / 2)
                        rrr2 = 0.75;
                    if (mult_RPb >= mult_RP / 2)
                        rrr2 = 0.25;
                ...
                if (mult_RP >= (CHIRP_thr + KRABRP_thr))
                    RP = TMath::ATan2(QY, QX) * TMath::RadToDeg();
                if (mult_RPa >= (CHIRP_thr + KRABRP_thr) / 2)
                    RPa = TMath::ATan2(QYa, QXa) * TMath::RadToDeg();
                if (mult_RPb >= (CHIRP_thr + KRABRP_thr) / 2)
                    RPb = TMath::ATan2(QYb, QXb) * TMath::RadToDeg();
                ...
                {
                    std::cout << "R3BAsyChimeraPhys:: subvents multiplicities differ by more than one " << mult_RP
                              << " " << mult_RPa << " " << mult_RPb << std::endl;
...
R3BAsyChiKrabPhysData* R3BAsyChimeraPhys::AddPhysData(Int_t Multi_CHI,
                                                      Int_t ZBound_CHI,
                                                      Float_t ZRat_CHI,
                                                      Float_t ERat_CHI,
                                                      Float_t RP_CHI,
                                                      ...
                                                      Float_t dRP12)
{
    ...
    return new (clref[size]) R3BAsyChiKrabPhysData(Multi_CHI,
                                                   ZBound_CHI,
                                                   ZRat_CHI,
                                                   ERat_CHI,
                                                   RP_CHI,
