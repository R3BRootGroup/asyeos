...
//              cout  << Z << " " << A << " " << Icod << " " << PID << " " << Fast << " " << NumTel << endl;
...
//              cout << EKin << " " << ETot << " " << gamma << " " << beta << " " << Z << " " << A << endl;
...
//	      cout << EKin << " " << ETot << " " << gamma << " " << beta << " " << ylab << " " << gammabt << endl;
...
R3BAsyChimeraIdData* R3BAsyChimeraId::AddIdData(UInt_t numtel, Float_t fast, Float_t slow, UInt_t time, Int_t Z, Int_t A, Int_t Stopped, Int_t Code, Float_t PID, double DE, double Energy)
{
