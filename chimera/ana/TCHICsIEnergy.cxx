...
int TCHICsIGSIEnergy::Init()
{
 ...
 if(!freg) {
  cout<<"TCHICsIGSIEnergy>> Calibration file "<<ffilenerg<<
 ...
 cout<<"TCHICsIGSIEnergy>> Read "<<row<<" lines from calibration file "
     <<ffilenerg<<endl;
 freg.close();
 fisdefined = true;
 //getchar();
...
//  ifstream pippo("../CALFILES/de-e-bs.txt"); 
  ...
  if(!pippo) cout << "error: file " << ffilenergrec << " not found"<< endl;
  pippo >> ZZZ >> AAA;
 ...
 if(de>0){
  ...
  if(fZ==1){
   if(fA==1){
    ...
    if(fA==1 && (fPID<0.5 || fPID>1.5) && (idr->Getcod()<3))idr->Setcod(kICODE5);//2011 code...needed?
   }//if(fA==1){
   ...
   if(fA==2){
    ...
    if(fA==2 && (fPID<1.5 || fPID>2.5) && (idr->Getcod()<3))idr->Setcod(kICODE5);//2011 code...needed?
   }//if(fA==2)
   ...
   if(fA==3){
    ...
    if(fA==3 && (fPID<2.5 || fPID>3.5) && (idr->Getcod()<3))idr->Setcod(kICODE5);//2011 code...needed?
    if(fA==3 && (de>292.8*tollup) && (fPID!=3) && (idr->Getcod()<3))idr->Setcod(kICODE4);//2011 code...needed?
    if(fA==3 && (de>292.8*tollup) && (fPID==3) && (idr->Getcod()<3))idr->Setcod(kICODE2);//2011 code...needed?
   }//if(fA==3)
    ...
    if(de < 222.1 && de>0){
     for (iii=0;iii<31;iii++){
      if(de>= DE11[iii] && de < DE11[iii+1]){
       erec=E11[iii]+(de-DE11[iii])/(DE11[iii+1]-DE11[iii])*(E11[iii+1]-E11[iii]);
      }
      if(de<DE11[0]){erec=-100;
       idr->Setcod(kICODE5);
      }
      if(de>DE11[30])erec=de+1;
     }
     idr->SetA(1);fA=1;
     stopped=0; 
     idr->SetUnStopped();
     if(idr->Getcod()<=3)idr->Setcod(kICODE3);
    }
   
    if(de>222.1 && de<292.8){
     for (iii=0;iii<45;iii++){
      if(de>= DE12[iii] && de < DE12[iii+1]){;
       erec=E12[iii]+(de-DE12[iii])/(DE12[iii+1]-DE12[iii])*(E12[iii+1]-E12[iii]);
      }
      if(de<DE12[0]){
       erec=-100;
       idr->Setcod(kICODE5);
      }
      if(de>DE12[44])erec=de+1;
     }
     idr->SetA(2);fA=2;
     stopped=0;
     idr->SetUnStopped();
    ...
    if(de>292.8 && de<347.6*tollup){
     for (iii=0;iii<41;iii++){
      if(de>= DE13[iii] && de < DE13[iii+1]){;
       erec=E13[iii]+(de-DE13[iii])/(DE13[iii+1]-DE13[iii])*(E13[iii+1]-E13[iii]);
      }
      if(de<DE13[0]){
       erec=-100;
       idr->Setcod(kICODE5);
      }
      if(de>DE13[40])erec=de+1;
     }
     idr->SetA(3);fA=3;
     stopped=0;
     idr->SetUnStopped();
...
//   if(cut4He->IsInside(fPID,de))idr->Setcod(kICODE5);2011 code...needed?
    if(fA==4 && (fPID<3.5 || fPID>4.5) && (idr->Getcod()<3))idr->Setcod(kICODE5);//2011 code...needed?
   }//if(fA==4)
    ...
    if(de<888.1*tollup){
     for (iii=0;iii<45;iii++){
      if(de>= DE24[iii] && de < DE24[iii+1]){;
       erec=E24[iii]+(de-DE24[iii])/(DE24[iii+1]-DE24[iii])*(E24[iii+1]-E24[iii]);
      }
      if(de<DE24[0]){
       erec=-100;
       idr->Setcod(kICODE5);
      }
      if(de>DE24[44])erec=de+1;
     }
     idr->SetA(4);fA=4;
     stopped=0;
     idr->SetUnStopped();
     if(idr->Getcod()!=5)idr->Setcod(kICODE3);
...
//   if(cut7Li->IsInside(fPID,de))idr->Setcod(kICODE5);2011 code...needed?
    if(fA==7 && (fPID<5.5 || fPID>7.5) && (idr->Getcod()<3))idr->Setcod(kICODE5);//2011 code...needed?
   }//if(fA==7){
    ...
    if(de < 1808.1*tollup){
     for (iii=0;iii<41;iii++){
      if(de>= DE37[iii] && de < DE37[iii+1]){;
       erec=E37[iii]+(de-DE37[iii])/(DE37[iii+1]-DE37[iii])*(E37[iii+1]-E37[iii]);
      }
      if(de<DE37[0]){
       erec=-100;
       idr->Setcod(kICODE5);
      }
      if(de>DE37[40])erec=de+1;
     }
     idr->SetA(7);fA=7;
     stopped=0;
     idr->SetUnStopped();
  ...
  if(fZ==4){
   if(fA==9){
    ...
    if(fA==9 && (fPID<6.5 || fPID>10.5) && (idr->Getcod()<3))idr->Setcod(kICODE5);//2011 code...needed?
   }//if(fA==9)
    ...
    if(de<2863.9*tollup){
     for (iii=0;iii<37;iii++){
      if(de>= DE49[iii] && de < DE49[iii+1]){;
       erec=E49[iii]+(de-DE49[iii])/(DE49[iii+1]-DE49[iii])*(E49[iii+1]-E49[iii]);
      }
      if(de<DE49[0]){
       erec=-100;
       idr->Setcod(kICODE5);
      }
      if(de>DE49[36])erec=de+1;
     }
     idr->SetA(9);fA=9;
     stopped=0;
     idr->SetUnStopped();
...
*/   
 ...
 fDE = de;
 if(stopped)fEnergy = fDE;
 if(!stopped)fEnergy = erec;
 fecod =  kENER0;
}
