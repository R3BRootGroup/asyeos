...
R3BAsyKrab::R3BAsyKrab(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot)
...
{
    FairRootManager::Instance()->Register("AsyKrabPoint", GetName(), fAsyKrabCollection, kTRUE);
}
...
R3BAsyKrabPoint* R3BAsyKrab::AddPoint(Int_t trackID,
                                      Int_t detID,
                                      Int_t volid,
                                      Double_t Z,
                                      Double_t A,
                                      ...
                                      Double_t LightYield)
{
    ...
    return new (clref[size])
        R3BAsyKrabPoint(trackID, detID, volid, Z, A, posIn, posOut, momIn, momOut, time, length, eLoss, LightYield);
}
