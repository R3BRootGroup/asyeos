...
class R3BAsyTofDvsNeuLandOnlineSpectra : public FairTask
{
  public:
    /**
     * Default constructor.
     ...
     */
    R3BAsyTofDvsNeuLandOnlineSpectra(const TString& name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BAsyTofDvsNeuLandOnlineSpectra();
