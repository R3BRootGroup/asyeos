...
R3BAsyKrabOnlineSpectra::R3BAsyKrabOnlineSpectra(const char* name, Int_t iVerbose)
...
InitStatus R3BAsyKrabOnlineSpectra::Init()
{
    ...
    // --- ------------------------------------- --- //
    if (verbose)
        LOG(info) << "R3BAsyKrabOnlineSpectra::Init line 80";
    ...
    if (verbose)
        LOG(info) << "R3BAsyKrabOnlineSpectra::Init line 87";
